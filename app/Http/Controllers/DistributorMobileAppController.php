        ...
        try
        {
             $result = OrderSummary::
                            ...
                            ->when($request->datefrom, function($query) use ($request) {
                                $query->where('tbl_order_summary.created_at','>=',$request->datefrom." 00:00:00")
                              ->where('tbl_order_summary.created_at','<=',$request->dateto." 23:59:59");
                              // [$request->datefrom.' 00:00:00',$request->dateto.' 23:59:59']);
                            }) 
