        ...
        try
        {
             $result = OrderSummary::
                            ...
                            ->when($request->datefrom, function($query) use ($request) {
                                $query->whereBetween('tbl_order_summary.created_at',[$request->datefrom->date('Y-m-d')." 00:00:00", $request->dateto->date('Y-m-d')." 23:59:59"]);// [$request->datefrom.' 00:00:00',$request->dateto.' 23:59:59']);
                            }) 
